...
*Dernière mise à jour: 01/02/2026 12:41:57*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 928ms | 67.39% | 63.95% | 73.4% |
| **Website** | ✅ Opérationnel | 311ms | 100% | 99.51% | 99.79% |
...
- **API** - ❌ Hors service depuis 17h 19m
- **API** - ⚠️ Dégradé depuis 23h 22m
