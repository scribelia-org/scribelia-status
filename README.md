...
*Dernière mise à jour: 01/02/2026 15:01:45*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ❌ Hors service | 10003ms | 67.03% | 63.88% | 73.37% |
| **Website** | ✅ Opérationnel | 144ms | 100% | 99.51% | 99.79% |
...
- **API** - ❌ Hors service depuis 19h 39m
