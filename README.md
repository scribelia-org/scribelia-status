...
*Dernière mise à jour: 13/01/2026 00:13:43*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 584ms | 68.22% | 73.86% | 78.19% |
| **Website** | ✅ Opérationnel | 275ms | 97.2% | 99.64% | 99.76% |
...
- **API** - ❌ Hors service depuis 9h 12m
- **API** - ⚠️ Dégradé depuis 10h 50m
