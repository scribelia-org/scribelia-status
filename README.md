...
*Dernière mise à jour: 30/01/2026 02:51:29*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 620ms | 58.82% | 70.58% | 74.44% |
| **Website** | ✅ Opérationnel | 277ms | 100% | 99.58% | 99.76% |
...
- **API** - ❌ Hors service depuis 9h 30m
