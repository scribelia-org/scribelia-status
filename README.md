...
*Dernière mise à jour: 28/12/2025 20:25:53*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 554ms | 84.89% | 86.02% | 86.02% |
| **Website** | ✅ Opérationnel | 966ms | 100% | 99.58% | 99.58% |
...
- **Temps de réponse moyen (7j):** 974ms
