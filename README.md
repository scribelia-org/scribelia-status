...
*Dernière mise à jour: 30/01/2026 00:54:03*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 596ms | 60.29% | 70.58% | 74.43% |
| **Website** | ✅ Opérationnel | 339ms | 100% | 99.58% | 99.76% |
...
- **API** - ❌ Hors service depuis 6h 27m
- **API** - ❌ Hors service depuis 7h 32m
