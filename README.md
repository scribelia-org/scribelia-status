...
*Dernière mise à jour: 01/02/2026 15:36:11*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ❌ Hors service | 10004ms | 66.3% | 63.82% | 73.37% |
| **Website** | ✅ Opérationnel | 369ms | 100% | 99.51% | 99.79% |
...
- **API** - ❌ Hors service depuis 20h 14m
...
- **Temps de réponse moyen (24h):** 258ms
