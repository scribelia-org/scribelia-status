...
*Dernière mise à jour: 28/12/2025 03:04:28*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ⚠️ Dégradé | 5612ms | 87.88% | 88.41% | 88.41% |
| **Website** | ✅ Opérationnel | 747ms | 99.24% | 99.28% | 99.28% |
...
- **Temps de réponse moyen (24h):** 1138ms
