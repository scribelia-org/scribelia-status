...
*Dernière mise à jour: 12/01/2026 22:26:21*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 621ms | 68.52% | 73.95% | 78.14% |
| **Website** | ✅ Opérationnel | 251ms | 97.22% | 99.64% | 99.76% |
...
- **API** - ❌ Hors service depuis 7h 25m
- **API** - ⚠️ Dégradé depuis 9h 3m
