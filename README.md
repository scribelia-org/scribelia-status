...
*Dernière mise à jour: 31/01/2026 01:53:40*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 619ms | 53.52% | 67.51% | 73.91% |
| **Website** | ✅ Opérationnel | 352ms | 100% | 99.55% | 99.79% |
...
- **API** - ❌ Hors service depuis 6h 32m
- **API** - ❌ Hors service depuis 8h 30m
