...
*Dernière mise à jour: 30/01/2026 18:55:43*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 674ms | 56.52% | 68.87% | 74.2% |
| **Website** | ✅ Opérationnel | 608ms | 100% | 99.56% | 99.76% |
...
- **API** - ❌ Hors service depuis 1h 32m
