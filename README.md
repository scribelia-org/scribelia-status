...
*Dernière mise à jour: 12/01/2026 22:54:07*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 695ms | 69.16% | 73.95% | 78.18% |
| **Website** | ✅ Opérationnel | 326ms | 97.2% | 99.64% | 99.76% |
...
- **API** - ❌ Hors service depuis 7h 53m
- **API** - ⚠️ Dégradé depuis 9h 31m
