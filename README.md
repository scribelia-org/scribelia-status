...
*Dernière mise à jour: 01/02/2026 17:31:00*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 559ms | 65.93% | 63.31% | 73.32% |
| **Website** | ✅ Opérationnel | 301ms | 100% | 99.5% | 99.79% |
...
- **API** - ❌ Hors service depuis 22h 8m
