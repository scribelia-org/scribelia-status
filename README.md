...
*Dernière mise à jour: 29/01/2026 11:23:13*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ⚠️ Dégradé | 9257ms | 57.33% | 70.78% | 74.69% |
| **Website** | ✅ Opérationnel | 153ms | 100% | 99.58% | 99.77% |
...
- **API** - ⚠️ Dégradé depuis 16h 2m
- **API** - ⚠️ Dégradé depuis 21h 13m
