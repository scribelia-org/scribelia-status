...
*Dernière mise à jour: 29/01/2026 20:09:09*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 524ms | 58.82% | 71.01% | 74.64% |
| **Website** | ✅ Opérationnel | 313ms | 100% | 99.58% | 99.77% |
...
- **API** - ❌ Hors service depuis 1h 42m
- **API** - ❌ Hors service depuis 2h 47m
