...
*Dernière mise à jour: 13/01/2026 11:23:18*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ⚠️ Dégradé | 9535ms | 68.14% | 74.25% | 77.98% |
| **Website** | ✅ Opérationnel | 180ms | 100% | 99.64% | 99.77% |
...
- **API** - ❌ Hors service depuis 20h 22m
- **API** - ⚠️ Dégradé depuis 22h 0m
