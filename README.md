...
*Dernière mise à jour: 01/02/2026 13:55:22*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 690ms | 67.39% | 64.05% | 73.4% |
| **Website** | ✅ Opérationnel | 568ms | 100% | 99.51% | 99.79% |
...
- **API** - ❌ Hors service depuis 18h 33m
...
- **Temps de réponse moyen (24h):** 254ms
