...
*Dernière mise à jour: 12/01/2026 20:03:01*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 694ms | 72.07% | 74.34% | 78.18% |
| **Website** | ✅ Opérationnel | 367ms | 97.3% | 99.64% | 99.76% |
...
- **API** - ❌ Hors service depuis 5h 2m
- **API** - ⚠️ Dégradé depuis 6h 39m
