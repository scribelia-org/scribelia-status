...
*Dernière mise à jour: 29/01/2026 20:43:55*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 542ms | 60.29% | 71.11% | 74.65% |
| **Website** | ✅ Opérationnel | 300ms | 100% | 99.58% | 99.77% |
...
- **API** - ❌ Hors service depuis 2h 17m
