...
*Dernière mise à jour: 30/01/2026 08:50:16*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ❌ Hors service | 10003ms | 60.29% | 70.49% | 74.45% |
| **Website** | ✅ Opérationnel | 312ms | 100% | 99.57% | 99.76% |
...
- **API** - ❌ Hors service depuis 14h 23m
- **API** - ❌ Hors service depuis 15h 28m
