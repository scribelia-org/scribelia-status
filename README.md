...
*Dernière mise à jour: 13/01/2026 08:18:08*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 541ms | 67.57% | 74.4% | 78.08% |
| **Website** | ✅ Opérationnel | 111ms | 99.1% | 99.64% | 99.77% |
...
- **API** - ❌ Hors service depuis 17h 17m
- **API** - ⚠️ Dégradé depuis 18h 55m
