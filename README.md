...
*Dernière mise à jour: 01/02/2026 18:46:10*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 667ms | 67.03% | 63.41% | 73.26% |
| **Website** | ✅ Opérationnel | 318ms | 100% | 99.5% | 99.79% |
...
- **API** - ❌ Hors service depuis 23h 24m
