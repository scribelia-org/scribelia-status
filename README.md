...
*Dernière mise à jour: 13/01/2026 11:48:19*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ⚠️ Dégradé | 9318ms | 68.14% | 74.25% | 77.95% |
| **Website** | ✅ Opérationnel | 329ms | 100% | 99.64% | 99.77% |
...
- **API** - ❌ Hors service depuis 20h 47m
- **API** - ⚠️ Dégradé depuis 22h 25m
