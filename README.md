...
*Dernière mise à jour: 04/02/2026 05:55:13*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 449ms | 47.37% | 59.13% | 71.41% |
| **Website** | ✅ Opérationnel | 924ms | 100% | 100% | 99.77% |
...
- **API** - ❌ Hors service depuis 6h 35m
