...
*Dernière mise à jour: 04/02/2026 09:56:54*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ⚠️ Dégradé | 9835ms | 53.45% | 59.36% | 71.5% |
| **Website** | ✅ Opérationnel | 808ms | 100% | 100% | 99.77% |
...
- **API** - ❌ Hors service depuis 10h 37m
- **API** - ⚠️ Dégradé depuis 17h 19m
