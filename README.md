...
*Dernière mise à jour: 30/01/2026 00:42:18*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 664ms | 60.29% | 70.62% | 74.45% |
| **Website** | ✅ Opérationnel | 271ms | 100% | 99.58% | 99.76% |
...
- **API** - ❌ Hors service depuis 7h 20m
