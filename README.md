...
*Dernière mise à jour: 30/01/2026 15:42:42*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ❌ Hors service | 10003ms | 58.82% | 69.83% | 74.35% |
| **Website** | ✅ Opérationnel | 394ms | 100% | 99.56% | 99.76% |
...
- **API** - ❌ Hors service depuis 21h 16m
- **API** - ❌ Hors service depuis 22h 21m
