...
*Dernière mise à jour: 30/01/2026 08:03:03*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 637ms | 58.82% | 70.53% | 74.43% |
| **Website** | ✅ Opérationnel | 389ms | 100% | 99.57% | 99.76% |
...
- **API** - ❌ Hors service depuis 13h 36m
- **API** - ❌ Hors service depuis 14h 41m
