...
*Dernière mise à jour: 30/01/2026 09:02:07*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 751ms | 61.76% | 70.44% | 74.43% |
| **Website** | ✅ Opérationnel | 115ms | 100% | 99.57% | 99.76% |
...
- **API** - ❌ Hors service depuis 14h 35m
- **API** - ❌ Hors service depuis 15h 40m
