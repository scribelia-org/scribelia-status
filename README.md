...
*Dernière mise à jour: 04/02/2026 13:25:37*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 627ms | 57.63% | 59.55% | 71.49% |
| **Website** | ✅ Opérationnel | 298ms | 100% | 100% | 99.77% |
...
- **API** - ❌ Hors service depuis 14h 6m
- **API** - ⚠️ Dégradé depuis 20h 47m
