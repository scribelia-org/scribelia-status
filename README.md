...
*Dernière mise à jour: 04/02/2026 21:01:20*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 744ms | 58.33% | 59.01% | 71.11% |
| **Website** | ✅ Opérationnel | 771ms | 100% | 100% | 99.77% |
...
- **API** - ⚠️ Dégradé depuis 30m
- **API** - ❌ Hors service depuis 21h 41m
