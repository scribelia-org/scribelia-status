...
*Dernière mise à jour: 01/02/2026 16:51:02*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 664ms | 67.39% | 63.47% | 73.33% |
| **Website** | ✅ Opérationnel | 578ms | 100% | 99.5% | 99.79% |
...
- **API** - ❌ Hors service depuis 21h 29m
