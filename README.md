...
*Dernière mise à jour: 30/01/2026 17:22:51*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ❌ Hors service | 10003ms | 55.88% | 69.44% | 74.29% |
| **Website** | ✅ Opérationnel | 194ms | 100% | 99.56% | 99.76% |
...
- **API** - ❌ Hors service depuis 22h 56m
