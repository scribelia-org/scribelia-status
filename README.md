...
*Dernière mise à jour: 30/01/2026 12:59:20*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 532ms | 61.43% | 70% | 74.36% |
| **Website** | ✅ Opérationnel | 593ms | 100% | 99.57% | 99.76% |
...
- **API** - ❌ Hors service depuis 19h 37m
