...
*Dernière mise à jour: 30/01/2026 15:01:22*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 1137ms | 60.87% | 70.01% | 74.37% |
| **Website** | ✅ Opérationnel | 490ms | 100% | 99.56% | 99.76% |
...
- **API** - ❌ Hors service depuis 21h 39m
