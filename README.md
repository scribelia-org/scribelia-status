...
*Dernière mise à jour: 30/01/2026 12:37:36*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ⚠️ Dégradé | 9436ms | 59.42% | 70.04% | 74.36% |
| **Website** | ✅ Opérationnel | 291ms | 100% | 99.57% | 99.76% |
...
- **API** - ❌ Hors service depuis 18h 11m
