...
*Dernière mise à jour: 12/01/2026 16:21:58*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 707ms | 73.73% | 74.58% | 78.23% |
| **Website** | ✅ Opérationnel | 293ms | 97.46% | 99.64% | 99.76% |
...
- **API** - ❌ Hors service depuis 1h 21m
- **API** - ⚠️ Dégradé depuis 2h 58m
