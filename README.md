...
*Dernière mise à jour: 04/02/2026 07:33:09*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 545ms | 50% | 59.08% | 71.47% |
| **Website** | ✅ Opérationnel | 822ms | 100% | 100% | 99.77% |
...
- **API** - ❌ Hors service depuis 8h 13m
- **API** - ⚠️ Dégradé depuis 14h 55m
