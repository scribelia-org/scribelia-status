...
*Dernière mise à jour: 12/01/2026 20:53:43*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ✅ Opérationnel | 670ms | 70.91% | 74.19% | 78.19% |
| **Website** | ✅ Opérationnel | 202ms | 97.27% | 99.64% | 99.76% |
...
- **API** - ❌ Hors service depuis 5h 52m
- **API** - ⚠️ Dégradé depuis 7h 30m
