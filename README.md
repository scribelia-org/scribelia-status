...
*Dernière mise à jour: 04/02/2026 18:01:29*
...
|---------|------|------------------|--------------|-------------|--------------|
| **API** | ⚠️ Dégradé | 8527ms | 58.33% | 59.14% | 71.34% |
...
- **API** - ⚠️ Dégradé depuis 1h 16m
- **API** - ❌ Hors service depuis 18h 42m
